...
void main() {
  ...
  test('6.1 StateBasedStore implements ContinuumStore', () {
    // Arrange & Act
    ...
    expect(store, isA<ContinuumStore>());
  });
  ...
  test(
    ...
    () async {
      ...
      // Assert — adapter received stream ID, aggregate, and event list.
      ...
      final events = captured[2] as List;
      expect(events, hasLength(1));
      expect(events.first, isA<CounterCreated>());
    },
  );
}
