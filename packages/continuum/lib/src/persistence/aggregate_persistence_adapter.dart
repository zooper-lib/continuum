...
///
/// Defined for design validation and future use. No store implementation
/// consumes this interface in the current change.
abstract interface class AggregatePersistenceAdapter<TAggregate> {
  ...
  /// the list of pending domain events. The adapter decides how to
