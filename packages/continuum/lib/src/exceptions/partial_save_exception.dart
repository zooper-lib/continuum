...
///
/// During [StateBasedSession.saveChangesAsync], each stream is persisted
/// independently. When some streams succeed and others fail, this exception
/// reports which streams were saved and which failed. Successfully saved
/// streams have their pending events cleared; failed streams retain theirs.
///
