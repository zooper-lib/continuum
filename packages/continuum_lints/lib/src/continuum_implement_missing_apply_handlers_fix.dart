...
final class ContinuumImplementMissingApplyHandlersFix extends DartFix {
  ...
  static const String fixId = 'continuum_implement_missing_apply_handlers';

  /// The lint code this fix targets.
  static const String _targetLintCodeName = 'continuum_missing_apply_handlers';

  /// Creates a quick-fix that implements missing apply handlers.
  ContinuumImplementMissingApplyHandlersFix();
  ...
  void run(
    ...
    final List<MethodElement> missingMethods = const ContinuumRequiredApplyHandlers().findMissingApplyHandlerMethods(classElement);
    ...
    final ChangeBuilder changeBuilder = reporter.createChangeBuilder(
      message: 'Implement missing apply handlers',
      priority: 0,
    );
