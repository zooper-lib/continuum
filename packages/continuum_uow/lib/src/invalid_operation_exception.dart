...
///
/// For example, applying a creation operation to an entity that is
/// already tracked in the session. This represents a programming error
/// where the caller is performing an operation that violates domain
/// invariants.
