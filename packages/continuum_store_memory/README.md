...
In-memory `EventStore` implementation for [Continuum](https://github.com/zooper-lib/continuum). Events are stored in memory and lost when the application exits.
